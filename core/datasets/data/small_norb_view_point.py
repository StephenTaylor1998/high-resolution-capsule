...
from core.datasets.transforms.small_norb_view_point import SmallNorbVPTrainTransform, SmallNorbVPValTransform, \
    SmallNorbVPTestTransform
...
class smallNORBViewPoint(data.Dataset):
    ...
    def __init__(self, root, exp='azimuth', train=True, familiar=True, transform=None, target_transform=None,
                 info_transform=None, download=False, mode="all"):
