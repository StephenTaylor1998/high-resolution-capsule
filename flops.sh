...
python flops.py -a hr_caps_r_fpn -s 1 3 32 32 -c 10 --backbone resnet18_dwt_tiny_half --routing-name-list Tiny_FPN Tiny_FPN Tiny_FPN --in-shape 3 32 32
python flops.py -a hr_caps_r_fpn -s 1 3 32 32 -c 10 --backbone resnet18_dwt_tiny_half --routing-name-list FPN FPN FPN --in-shape 3 32 32
python flops.py -a hr_caps_tiny_fpn -s 1 3 32 32 -c 10 --backbone resnet18_dwt_tiny_half --routing-name-list FPN FPN FPN --in-shape 3 32 32
